...
const navLinks = [
  { label: 'Home', to: '/' },
  {
    ...
    to: '/divisions',
    children: [
      { label: '5U + 7U', to: '/divisions#5u-7u' },
      { label: '9U', to: '/divisions#9u' },
      ...
      { label: '15U / 18U Softball', to: '/divisions#softball18u' },
    ],
  },
      ...
      >
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3 group">
            <img src="/logo.png" alt="Logo" className="h-10 w-10 sm:h-15 sm:w-15 object-contain rounded-full bg-white sm:mb-0 mb-2" />
